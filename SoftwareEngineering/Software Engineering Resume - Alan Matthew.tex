...
\begin{document}
  ...
  % utilities to efficiently query large quantities of time-series data and cache
  % reimplemented daily jobs more robustly and efficiently, speeding up time to access data and reports by 30% 
  \ResumeItemListEnd
  \ResumeEntryEnd
  ...
  % \ResumeItemDefault{Debugged out of memory issues and optimized Python resource usage, saving AWS costs by 80\%.}
  \ResumeItemListEnd
  \ResumeEntryEnd
