...
\EduMeta
  ...
  \ResumeItemDefault{Conducted high-frequency signal research, analyzing market microstructure and large-scale trading data to identify and evaluate systematic trading opportunities.}

  \ResumeItemDefault{Developed and refined volatility and interest rate models to support options pricing, relative-value analysis, and trading decisions.}

  \ResumeItemDefault{Actively traded options and managed live systematic strategies, monitoring execution, portfolio exposures, and real-time risk while adjusting hedges and positioning as market conditions evolved.}
