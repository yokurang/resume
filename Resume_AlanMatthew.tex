...
\def \websitetext { https://yokurang-com.vercel.app/ }
...
\begin{document}
  ...
  \ResumeEntryStart
    ...
    % \ResumeSubItem{Activities}{Teaching Assistant for Data Structures and Algorithm, Probability, and Databases}
  ...
  \ResumeEntryStart
    ...
    \ResumeItem{Market-Pool Linkage}
      {Leveraged \textbf{Golang} to automatically link markets and liquidity pools, eliminating manual work and and securely allocating USD \$130+ million of capital across the exchange.}
