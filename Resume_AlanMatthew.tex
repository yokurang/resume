...
\begin{document}
  ...
  \ResumeItemDefault{Debugged memory issues and optimized \textbf{Python} resource usage, saving 140,000 SGD in costs.}
  \ResumeItemListEnd
  \ResumeEntryEnd
  ...
  \ResumeItemListStart
  \ResumeItemDefault{Implemented Zipper data structure in \textbf{OCaml} for efficient navigation of large diff files.}
  \ResumeItemDefault{Developed side-by-side and word-level diff views in \textbf{OCaml}, enhancing file comparison granularity.}
  \ResumeItemDefault{Designed novel ''blocks'' data structure to optimize diff organization and representation.}
  \ResumeItemDefault{Integrated pager functionality for improved navigation of large diff outputs.}
  \ResumeItemDefault{Engineered space-efficient linear implementation of Myers diff algorithm in \textbf{OCaml}.}
  \ResumeItemListEnd
  \ResumeEntryEnd
