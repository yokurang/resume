...
\begin{document}
  ...
  \ResumeEntryStart
  \ResumeEntryTSDL{Caladan}{High Frequency Market Making in Singapore}{Software Engineering Intern}{May 2024 - Aug 2024} 
      \ResumeItemListStart
      \ResumeItemDefault{Helped build a trade server in \textbf{C\#} to execute trades on the exchange and manage risk.}
      \ResumeItemDefault{Helped build analysis libraries to gain insight into the markets and identify issues in the trading system.}
      \ResumeItemListEnd
  \ResumeEntryEnd
