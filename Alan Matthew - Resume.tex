...
\begin{document}
  ...
  \ResumeEntryStart
    \ResumeItem{Languages}{C++, Python, TypeScript, JavaScript, Golang, Scala, Kotlin, OCaml, Rust, PHP, SQL}
    \ResumeItem{Frameworks}{React, Vue.js, Next.js, Spring Boot, Express.js, Flask, Laravel, AWS Lambda, DynamoDB}
  \ResumeEntryEnd
